...
if( get_option('mbwp_heartbeat')=='1'){
...
if(get_option('mbwp_shortlink')=='1'){

	//delete shortlink
	remove_action('wp_head', 'wp_shortlink_wp_head', 10, 0);
}
if(get_option('mbwp_pingback')=='1'){
...
if(get_option('mbwp_remove_qurey_string')=='1'){
...
if(get_option('mbwp_hide_wp')=='1'){

	//Hide WordPress Version
	remove_action( 'wp_head', 'wp_generator' ) ;
}

if(get_option('mbwp_dns_prefetch')=='1'){
...
if(get_option('mbwp_contact_form')=='1'){
...
if(get_option('mbwp_WLManifest')=='1'){

	//Remove WLManifest Link
	remove_action( 'wp_head', 'wlwmanifest_link' ) ;

}
if(get_option('mbwp_Remove_JQuery')=='1'){
...
if(get_option('mbwp_dashicons')=='1'){
...
if(get_option('mbwp_remove_url_comment')=='1'){
...
if(get_option('mbwp_disable_acf')=='1'){
...
if(get_option('mbwp_preload_fonts')){
